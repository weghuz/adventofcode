fn main() {
    ...
    main::advent_of_code_day_1(input);
}

pub mod main {

    pub fn advent_of_code_day_1(input: Vec<&str>) -> i32 {
        let array_strings = [
...
mod tests {
    ...
    fn test_advent_of_code_day_1(#[case] line: &str, #[case] expected: i32) {
        assert_eq!(main::advent_of_code_day_1(vec![line]), expected);
    }
}
